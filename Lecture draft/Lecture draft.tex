...
\begin{align}
(\pi_{L,b})(r,z)=\pi_{L}(x,x'), r=x, z=\log(\frac{x}{x'}),\quad e^{z}=\frac{x}{x'},\quad x'=e^{-z}r
\end{align}
Therefore
\begin{align}
...
\begin{align}
\mu_1\in \mathcal{S}^{0,\epsilon, \epsilon+\delta_1, \epsilon+\delta_1},\quad \mu_2\in\mathcal{S}^{0,\epsilon, \epsilon+\delta_2,\epsilon+\delta_2}
\end{align}
...
For $\lambda\ne0$, the symmetric principal value is
\begin{align}
\operatorname{pv}\frac{1}{\pi}\int_{\R}(i\tau+\lambda)^{-1}\,d\tau
&=\lim_{A\to\infty}\frac{1}{\pi}
  \int_{-A}^{A}\frac{\lambda-i\tau}{\lambda^2+\tau^2}\,d\tau\\
&=\lim_{A\to\infty}\frac{2}{\pi}
  \arctan\!\left(\frac{A}{|\lambda|}\right)\operatorname{sgn}(\lambda)\\
&=\operatorname{sgn}(\lambda).
\end{align}
The imaginary part vanishes because it is odd. In particular, for
nonzero real numbers $\lambda_1,\ldots,\lambda_N$, we have
